...
# Desktop
folder_path = '/home/at15963/Dropbox/work/papers/bamber_fwf/'
...
## DISABLED 2018/04/05 - was causing a bounds problem with spatial join
#basins_pstere.columns = ['GRIDCODE', 'area', 'geometry', 'basin']
# D this instead
basins_pstere = basins_pstere.rename(columns={'name':'basin'})
...
# Add a total of constant 10Gt/yr to northern unsurveyed areas 
# As per Michalea King's pers.comm on 22/12/2017
# The corresponds to basins 2, 3 and 4
constant_basin_contrib = 10. / 3
for basin in ['basin2', 'basin3', 'basin4']:
	glaciers_combined[basin] += constant_basin_contrib
...
# Load runoff t/s generated by greenland_runoff_contributions.py
annual_runoff_all = pd.read_csv(folder_path + 'outputs_Jan2018/greenland_runoff_contributions.csv',
	parse_dates=True, index_col='time')
annual_runoff = annual_runoff_all['GrIS grounded']
...
if grid:
	...
	# Load routed runoff to use for georeferencing etc
	...
	dist_land = georaster.SingleBandRaster(folder_path + 'outputs_Jan2018/ROUTING_distances_landandice.tif')
